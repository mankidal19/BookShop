...
//  private static CatalogItem[] items = null;
    private static List<CatalogItem> items = null;
...
//        };
  ...
  public static CatalogItem getItem(String itemID) throws SQLException, ClassNotFoundException {
    CatalogItem item;
    items = DBUtils.queryAllBook();
    if (itemID == null) {
      return(null);
    }
